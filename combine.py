...
import cv2
#10 13 138 679 1488 4938 5008 6799 7246 7271 9992 9998
# define paths for translation from domain A (images in folderA) -> domain B (images in folderB)
# folderA = './dataset/raw'
# folderB = './dataset/processed'
# dest_path = './dataset/official'
folderA = './dataset/256raw'
folderB = './dataset/256blurry'
dest_path = './dataset/256official'
# folderA = './pytorch-CycleGAN-and-pix2pix/results/Incremental/'
# folderB = './pytorch-CycleGAN-and-pix2pix/results/Incremental/'
# dest_path = './pytorch-CycleGAN-and-pix2pix/results/Incremental/official/test/'
